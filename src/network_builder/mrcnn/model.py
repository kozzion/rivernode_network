...
class MaskRCNN():
    ...
    def build(self, mode, config):
        ...
        if mode == "training":
            ...
            gt_boxes = KL.Lambda(lambda x: utils.norm_boxes_graph(x, K.shape(input_image)[1:3]))(input_gt_boxes)
            ...
            if config.USE_MINI_MASK:
                ...
                input_gt_masks = KL.Input(hape=[config.IMAGE_SHAPE[0], config.IMAGE_SHAPE[1], None], name="input_gt_masks", dtype=bool)
        elif mode == "inference":
        ...
        rpn_rois = ProposalLayer(
            ...
            count_image_per_gpu=config.IMAGES_PER_GPU)([rpn_class, rpn_bbox, anchors])
